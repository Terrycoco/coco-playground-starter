...
import { StyleForm, TextForm } from "@/dev/components/forms";
...
function remToEm(obj) {
  let newobj = { ...obj };
  if (obj.hasOwnProperty("fontSize")) {
    newobj.fontSize = obj.fontSize.replace("rem", "em");
  }
  return newobj;
}
...
export default function TypographyPage() {
  ...
  useEffect(() => {
    ...
    //these need to be in em
    setStyleObj(theme.text.p); //default
    setH1(remToEm(theme.text.h1));
    setH2(remToEm(theme.text.h2));
    setH3(remToEm(theme.text.h3));
    setH4(remToEm(theme.text.h4));
    setH5(remToEm(theme.text.h5));
    setH6(remToEm(theme.text.h6));
    setP(remToEm(theme.text.p));
  }, []);
  ...
  const clickMe = (e) => {
    ...
    switch (el) {
      case "h1":
        setStyleObj(theme.text.h1);
        break;
      case "h2": {
        setStyleObj(theme.text.h2);
        break;
      }
      case "h3":
        setStyleObj(theme.text.h3);
        break;
      case "h4": {
        setStyleObj(theme.text.h4);
        break;
      }
      case "h5":
        setStyleObj(theme.text.h5);
        break;
      case "h6": {
        setStyleObj(theme.text.h6);
        break;
      }
      case "p": {
        setStyleObj(theme.text.p);
        break;
      }
    }
    setSection("text");
        ...
        <Layout>
          ...
          <section style={theme.spacing.section}>
            <ScreenEmulator id="emulator" device={device}>
              ...
              >
                Headline Scales and Typography
              </h2>
              <p
                data-el="p"
                onClick={clickMe}
