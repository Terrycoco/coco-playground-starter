var { toCamelCase, isOneOf } = require("./strings");
...
var {
  ...
  Roboto_Flex,
  Montserrat,
} = require("../../../node_modules/@next/font/google");
...
const getFontNameFromVar = (variable = "") => {
  ...
  // TODO: futureproof list of theme categories
  if (isOneOf(str, ["body", "display", "special", "mono"])) {
    return str;
  }
