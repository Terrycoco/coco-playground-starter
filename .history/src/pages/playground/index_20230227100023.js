    ...
    <>
      ...
      <main>
        <Layout onClickSpacing={toggleSpacing}>
          <section
            style={{
              paddingTop: theme.spacing.sectionPaddingTop,
              paddingRight: theme.spacing.sectionPaddingRight,
              paddingBottom: theme.spacing.sectionPaddingBottom,
              paddingLeft: theme.spacing.sectionPaddingLeft,
            }}
          >
