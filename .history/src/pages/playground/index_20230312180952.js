        ...
        <Layout>
          <section>
            <h1 style={getTextStyle("h1")}>
              (h1) This the result of your Theme
            </h1>
            <h2 style={getTextStyle("h2")}>
              (h2) Your Default Styles Are Shown
            </h2>

            <p data-el="p" style={getTextStyle("p")}>
              (p) Your typography styles will show up here. These are the
              default styles for each element, which will be consistent across
              your project. You can, of course, alter them for individual
