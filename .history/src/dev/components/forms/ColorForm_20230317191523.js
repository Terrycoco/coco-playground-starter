...
import { Button, Tab } from "@/components/buttons";
...
const ColorForm = (props) => {
  ...
  const styles = {
    ...
    tab: {
      fontFamily: variants["var(--font-forms)"],
      flexBasis: "50%",
  ...
  return (
    <>
      <div style={styles.tabrow}>
        <Tab id={1} onClick={clickTab} style={styles.tab}>
          Elements
        </Tab>
        <Tab id={2} onClick={clickTab} style={styles.tab}>
          Settings
        </Tab>
      </div>
      <FormWrapper>
