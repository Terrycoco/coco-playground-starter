      ...
      <main>
        <Layout>
          <div className={css.scalepage}>
            ...
            {tab === 2 && (
              <div className={css.scalecopy} style={styles.parablock}>
                <div style={{ fontSize: "27px" }}>I am H6 next size up</div>
                <div style={{ fontSize: "36px" }}>I am H6 next size up</div>
                <div style={{ fontSize: "45px" }}>I am H6 next size up</div>
                <div style={{ fontSize: "54px" }}>I am H6 next size up</div>
                <div style={{ fontSize: "63px" }}>I am H6 next size up</div>
                <div style={{ fontSize: "72px" }}>I am H6 next size up</div>
              </div>
            )}
