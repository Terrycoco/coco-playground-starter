      ...
      <StyleGrid title="theme fonts">
        <StyleGridItem label="body">
          <FontDropdown
            options={options}
            id="body"
            defaultObj={themeFonts.filter((obj) => obj.category == "body")}
        ...
        <StyleGridItem label="headings">
          <FontDropdown
            options={options}
            id="display"
            defaultObj={themeFonts.filter((obj) => obj.category == "display")}
            onSelect={handleSelect}
          />
        </StyleGridItem>
        <StyleGridItem label="forms">
          <FontDropdown
            options={options}
            id="forms"
            defaultObj={themeFonts.filter((obj) => obj.category == "forms")}
            onSelect={handleSelect}
          />
        </StyleGridItem>
        <StyleGridItem label="special">
          <FontDropdown
            options={options}
            id="special"
            defaultObj={themeFonts.filter((obj) => obj.category == "special")}
            onSelect={handleSelect}
          />
        </StyleGridItem>
        <StyleGridItem label="mono">
          <FontDropdown
            options={options}
            id="mono"
            defaultObj={themeFonts.filter((obj) => obj.category == "mono")}
            onSelect={handleSelect}
          />
        </StyleGridItem>
      </StyleGrid>
