        ...
        >
          ...
          <section style={getSpacingStyle("section")}>
            ...
            <p data-el="p" style={getTextStyle("p")}>
              ...
              "SCALE". The rest of the paragraph settings can be found by
              clicking "TYPOGRAPHY"l
            </p>

            <p data-el="p" style={getTextStyle("p")}>
              Don't like the spacing? Click "SPACING" to set default padding and
              margins for elements like sections,
            </p>
          </section>
