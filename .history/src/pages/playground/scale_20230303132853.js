...
export default function Scale() {
  ...
  const [fs3, setFs3] = useState(false);
  const [fs4, setFs4] = useState(false);
  const [fs5, setFs5] = useState(false);
            ...
            {tab === 1 && (
              <div className={css.scalecopy} style={styles.parablock}>
                ...
                <div id="para">
                  ...
                  <div style={getParaStyle()}>
                    When you are satisfied that it looks right at mobile size,
