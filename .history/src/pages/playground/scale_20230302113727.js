      ...
      <main>
        <Layout>
          <div className={css.scalepage}>
            ...
            {tab === 2 && (
              <div className={css.scalecopy} style={styles.parablock}>
                <h6 style={{ fontSize: "27px" }}>I am H6 next size up</h6>
                <h5 style={{ fontSize: "36px" }}>I am H6 next size up</h5>
                <h4 style={{ fontSize: "45px" }}>I am H6 next size up</h4>
                <h3 style={{ fontSize: "54px" }}>I am H6 next size up</h3>
                <h2 style={{ fontSize: "63px" }}>I am H6 next size up</h2>
                <h2 style={{ fontSize: "72px" }}>I am H6 next size up</h2>
              </div>
            )}
