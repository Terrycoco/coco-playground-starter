...
const initialState = {
  ...
  objs: {
    body: {
      value: getFontVariable(currentTheme.fonts.body),
      label: currentTheme.fonts.body,
    },
    display: {
    ...
    forms: {
      value: getFontVariable(currentTheme.fonts.forms),
      label: currentTheme.fonts.forms,
    },
    special: {
    ...
    mono: {
      value: getFontVariable(currentTheme.fonts.mono),
      label: currentTheme.fonts.mono,
    },
  },
};
