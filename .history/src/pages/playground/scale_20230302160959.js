      ...
      <main>
        <Layout>
          <div className={css.scalepage}>
            {tab === 1 && (
              <div className={css.scalecopy} style={styles.parablock}>
                <div style={getP1Style()}>
                  I Am The First Level Up Heading (p1){" "}
                </div>
                <div id="para">
            ...
            {tab === 2 && (
              <div className={css.scalecopy} style={styles.parablock}>
                <div style={{ fontSize: sizes.p6, lineHeight: p1LineHeight }}>
                  P6 I am the next size up
                </div>
                <div style={{ fontSize: sizes.p5, lineHeight: p1LineHeight }}>
                  P5 I am the next size up
                </div>
                <div style={{ fontSize: sizes.p4, lineHeight: p1LineHeight }}>
                  P4 I am the next size up
                </div>
                <div style={{ fontSize: sizes.p3, lineHeight: p1LineHeight }}>
                  P3 I am the next size up
                </div>
                <div style={{ fontSize: sizes.p2, lineHeight: p1LineHeight }}>
                  P2 I am the next size up
                </div>
                <div style={{ fontSize: sizes.p1, lineHeight: p1LineHeight }}>
                  P1 I am the next size up
                </div>
              </div>
            )}
