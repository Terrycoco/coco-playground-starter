    ...
    <>
      ...
      <main>
        <Layout onClickSpacing={toggleSpacing}>
          <section
            style={{
              paddingTop: theme.spacing.section.paddingTop,
              paddingRight: theme.spacing.section.paddingRight,
              paddingBottom: theme.spacing.section.paddingBottom,
              paddingLeft: theme.spacing.section.paddingLeft,
            }}
          >
