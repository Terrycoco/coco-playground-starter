          ...
          <div style={styles.grid}>
            <div style={styles.parablock}>
              <div id="para" style={getParaStyle()}>
                To create the scale for the project, first select your paragraph
                font. Play with the size of the font, until it looks crisp and
                "right" to your eye. Then, play with the line height for
                readability. Once you have the paragraph settings, select a
                ratio, or how much <b>contrast</b> you want between different
                sizes. The calculator will then generate suggested harmonious
                sizes.
              </div>
            ...
            {showResult && (<div id="scaleblock" style={styles.parablock}>
              <div id="para" style={getParaStyle()}>
                To create the scale for the project, first select your paragraph
                font. Play with the size of the font, until it looks crisp and
                "right" to your eye. Then, play with the line height for
