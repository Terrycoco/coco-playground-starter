...
import ScreenTabs from "@/dev/components/viewport/ScreenTabs";
        ...
        <Page>
          <section style={theme.spacing.section}>
            <FlexLayout>
              <FlexColumn>
                <ScreenTabs />
                <ScreenEmulator id="emulator">
                  <h1
                    data-el="h1"
                    style={h1}
                    onClick={clickMe}
                    className={
                      element == "h1" ? css.isSelected : css.isNotSelected
                    }
                  >
                  ...
                  <p
                    ...
                    style={p}
                    className={
                      element == "p" ? css.isSelected : css.isNotSelected
                    }
                  >
                    Play with typography here. I am a paragraph style. Lorem
                  ...
                  <h2
                    ...
                    style={h2}
                    className={
                      element == "h2" ? css.isSelected : css.isNotSelected
                    }
                  >
                    I am a h2 heading
                  </h2>
                  <h3
                    ...
                    style={h3}
                    className={
                      element == "h3" ? css.isSelected : css.isNotSelected
                    }
                  >
                    I am a h3 heading
                  </h3>
                  <h4
                    ...
                    style={h4}
                    className={
                      element == "h4" ? css.isSelected : css.isNotSelected
                    }
                  >
                    I am a h4 heading
                  </h4>
                  ...
                  <h5
                    ...
                    style={h5}
                    className={
                      element == "h5" ? css.isSelected : css.isNotSelected
                    }
                  >
                    I am a h5 heading
                  </h5>
                  <h6
                    ...
                    style={h6}
                    className={
                      element == "h6" ? css.isSelected : css.isNotSelected
                    }
                  >
                    I am a h6 heading
                  </h6>
