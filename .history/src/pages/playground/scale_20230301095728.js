          ...
          <section>
            <div style={styles.grid}>
              <div id="col1" style={styles.para}>
                <div id="para">
                  To start setting the scale for the project, select your body
                  font. Play with the size of the font, until it looks crisp and
                  "right". When you've selected the size, enter it into the
                  calculator. Then, select a ratio, or how much contrast you
                  want between different sizes. The calculator will then
                  generate modular sizes.
                </div>
                <small>Body Font Size: {getFontSize()}</small>
              </div>
              <div id="col2" style={styles.form}></div>
            </div>
          </section>
        </Layout>
      </main>
