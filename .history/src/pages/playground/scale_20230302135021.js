...
export default function Scale() {
  ...
  const [pFont, setCurrentFont] = useState();
  const [pFontSize, setCurrentFontSize] = useState();
  const [pRatio, setCurrentRatio] = useState();
  const [pLineHeight, setCurrentLineHeight] = useState();
            ...
            {tab === 1 && (
              <div className={css.scalecopy} style={styles.parablock}>
                ...
                <div className="scalecopy" style={styles.labelblock}>
                  <div style={styles.label}>Current Font: {pFont}</div>
                  <div style={styles.label}>
                    Current Font Size: {pFontSize}
                  </div>
                </div>
              </div>
            )}
