      ...
      <main>
        ...
        >
          ...
          <section style={getSpacingStyle("section")}>
            ...
            <p data-el="p" style={getTextStyle("p")}>
              This is the paragraph element. To alter the size and scale between
              paragraph and the headings, go to "SCALE". The rest of the
              paragraph settings can be found by clicking "TYPOGRAPHY"l
            </p>
