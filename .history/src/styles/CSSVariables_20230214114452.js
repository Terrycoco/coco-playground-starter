...
const GlobalStyle = createGlobalStyle`
 html: {
   --font-body: ${(props) => getFontVariable(props.theme.fonts.display)};
   --font-display: ${(props) => getFontVariable(props.theme.fonts.display)};
   --font-special: ${(props) => getFontVariable(props.theme.fonts.display)};
   --font-mono: ${(props) => getFontVariable(props.theme.fonts.display)};
 }
`;
