...
export default function Scale() {
  ...
  const generate = () => {
    let fs = getValFromCSS(pFontSize);
    let ratio = fs / getValFromCSS(pFontSize);
    setP1Ratio(ratio);
    setSizes(calcScale(pFontSize, ratio));
    setTab(2);
  };
      ...
      <main>
        <Layout>
          <div className={css.scalepage}>
            ...
            {tab === 2 && (
              <div className={css.scalecopy} style={styles.parablock}>
                <div style={{ fontSize: sizes.p6 }}>I am the next size up</div>
                <div style={{ fontSize: sizes.p5 }}>I am the next size up</div>
                <div style={{ fontSize: sizes.p4 }}>I am the next size up</div>
                <div style={{ fontSize: sizes.p3 }}>I am the next size up</div>
                <div style={{ fontSize: sizes.p2 }}>I am the next size up</div>
                <div style={{ fontSize: sizes.p1 }}>I am the next size up</div>
              </div>
            )}
