          ...
          <div className={css.scalepage}>
            ...
            {tab === 2 && (
              <div className={css.scalecopy} style={styles.parablock}>
                ...
                <div style={{ fontSize: sizes.p5, lineHeight: "1.1" }}>
                  P5 I am the next size up
                </div>
                <div style={{ fontSize: sizes.p4, lineHeight: "1.1" }}>
                  P4 I am the next size up
                </div>
                <div style={{ fontSize: sizes.p3, lineHeight: "1.1" }}>
                  P3 I am the next size up
                </div>
                <div style={{ fontSize: sizes.p2, lineHeight: "1.1" }}>
                  P2 I am the next size up
                </div>
                <div style={{ fontSize: sizes.p1, lineHeight: "1.1" }}>
