...
const _default = {
  ...
  text: {
    p: {
      color: eval(this.colors.blackish),
      fontFamily: eval(this.fonts.body),
      fontWeight: "400",
      fontSize: eval(this.fontSizes.mobile.body),
      lineHeight: eval(this.fontSizes.mobile.body.lineHeight),
